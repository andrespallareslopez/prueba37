   ...
   ns.isMobile = {
    ...
    ns.buildtemplate=(function(){
        return function(params){
            ...
            //}else{
               //$(html).attr("id")=params.id+"1"; 
               //console.log("nombre del template");
               //console.log($(html).attr("id")+"-"+params.id);
               /*
               if (!$(html).attr("id")){
                   ...
                   $(html)[0].setAttribute("id","menuhorizonal01");
                   $(html).attr("id",params.id);
                   $(html,{'id':'menuhoriontal04'});
                   $(html)[0].id="id='menuhorizontal04'";
                   $(html)[0].attributes.item(1).value="menuhorizontal04";
               ...
               */
              //console.dir(html);
              //console.log(params.typeInsertHTML);
             ...
             Promise.all([p1,p2]).then(function(values){
                ...
                switch (state){
                    ...
                    case "reload":
                      ...
                      break;  
                    default:
                     console.log("eestoy en defaul en "+nametemplate);
     ...
     ns.debounce = function (func, wait, immediate) {
         var timeout;
         return function () {
