...
;(function(ns){
    ...
    //***********************************************
    ns.slidePanelContainer=(function(){
        return function(options){

            this.init(options);
            this.config={};
            (function(config){
                config.container=config.container||".slide-container";
    ...
    ns.slidePanelContainer.prototype=new ns.container();
    //*******************************************************
    ...
    //*****************************************************************
    ns.slidePanelContainer.prototype.initevent=function(){
       var self=this;
       calcularslides();
